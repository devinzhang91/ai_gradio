...
def recognize_from_audio(filename : str  = None):
    ...
    try:
        ...
        speech_config = speechsdk.SpeechConfig(subscription=AzureSpeechConf.SPEECH_KEY, 
                                               region=AzureSpeechConf.SPEECH_REGION)
...
def synthesize_to_output(text_to_speech : str,
    ...
    try:
        ...
        speech_config.speech_synthesis_voice_name = AzureSpeechConf.SPEECH_VOICE_LIST[1]
